...
### ▼感想
正直ソース読みづらい、というかひどい。  
何故かbit列になっているフラグもあればboolになっているフラグもあったり、  
処理速度を気にしてそうな雰囲気も多少あるのにアロケーションが死ぬほど多用されていたり何だりで色々と打ち消されていたり、    
大量にstaticがあって、それを好き勝手な場所で変更したり参照したり、繋げて使っていたり、    
各クラスのカプセル化も殆ど意識されていなくて、メソッドの呼び出しレイヤーや親子関係みたいなものが殆ど無いので呼び出し口もバラバラだったり、   
循環参照しまくっていてどこに何があるのかさっぱり分からない上にリークも大量に発生していたり、    
同じ意味合いの機能や値が大量にあって、アクセス方法も統一感やポリシーもなく関数だったりプロパティだったり直変数だったり、    
継承も循環参照で潰されていてoverrideも殆ど意味がなくなっていたり、    
同一の機能も大量に点在していて、その全てがちょいつまみ食いみたいな感じで使われていて見苦しかったり、    
ノリで拡張し続けて作ってるのがとても良く伝わってくる。    
あとIDとかカテゴリとかを文字列で定義して、文字列定数も用意しないでバシバシハードコードするのは流石によろしくないんじゃないのって思うのアタシ。    
でもゲーム自体は最高に面白いから関係ないし正義だよね、勝手にソース読んでるのはこっちなので文句を言うのはお門違いですよ。    
すまんな。    
